...
def get_rag_manager():
    ...
    try:
        ...
        # [MyAi bridge patch] honor ODYSSEUS_DATA_DIR for per-tenant RAG isolation.
        base_dir = Path(__file__).parent.parent
        persist_dir = os.path.join(os.environ.get("ODYSSEUS_DATA_DIR") or os.path.join(base_dir, "data"), "rag")
