...
# [MyAi bridge patch] honor ODYSSEUS_DATA_DIR for per-tenant encryption-key
# isolation (a shared .app_key would mean every tenant shares one Fernet key).
_KEY_PATH = Path(os.environ.get("ODYSSEUS_DATA_DIR") or (Path(__file__).resolve().parent.parent / "data")) / ".app_key"
_PREFIX = "enc:"
