...
# [MyAi bridge patch] honor ODYSSEUS_DATA_DIR for per-tenant isolation.
DATA_FILE = os.path.join(os.environ.get("ODYSSEUS_DATA_DIR") or os.path.join(os.path.dirname(os.path.dirname(__file__)), "data"), "integrations.json")
...
def migrate_from_settings() -> None:
    ...
    settings_path = os.path.join(os.environ.get("ODYSSEUS_DATA_DIR") or os.path.join(os.path.dirname(os.path.dirname(__file__)), "data"), "settings.json")  # [MyAi bridge patch] per-tenant
